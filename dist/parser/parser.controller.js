...
let ParserController = class ParserController extends base_controller_1.BaseController {
    constructor(loggerService, configService, parserService) {
        super(loggerService);
    ...
    parse({ body }, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.parserService.parse(body.vin);
            this.ok(res, result);
        });
    }
};
